    ...
    ,items = {
      ...
      select: function(){
        ...
        selects.each(function(index, select){
          ...
          var isSmall = othis.hasClass("layui-input-small");
          //替代元素
          var reElem = $(['<div class="layui-unselect '+ CLASS + (disabled ? ' layui-select-disabled' : '') +'">'
            ,'<div class="'+ TITLE +'"><input type="text" placeholder="'+ placeholder +'" value="'+ (value ? selected.html() : '') +'" '+ (isSearch ? '' : 'readonly') +' class="layui-input layui-unselect '+(isSmall ?('layui-input-small'):'')+ (disabled ? (' '+DISABLED) : '') +'">'
      ...
      ,checkbox: function(){
        ...
        checks.each(function(index, check){
          ...
          }[skin] || ((check.title.replace(/\s/g, '') ? ('<span>'+ check.title +'</span>') : '') +'<i class="layui-icon iconfont icon-check"></i>')
          ,'</div>'].join(''));
